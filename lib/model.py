...
class DenseFeatureExtractionModule(nn.Module):
    def __init__(self, finetune_feature_extraction=False, model_type=None, pretrained=False, finetune_layers=2, use_cuda=True):
...
class D2Net(nn.Module):
    def __init__(self, model_file=None, model_type=None, pretrained=False, finetune_layers=2, use_cuda=True):
